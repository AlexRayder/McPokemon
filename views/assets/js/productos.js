                ...
                table.row.add({
                    ...
                    "Estado": `
                        <div class="form-check form-switch">
                            <input onclick="status(${producto.id},'${producto.estado}')" class="form-check-input" type="checkbox" role="switch" id="switch${producto.nombrePro}" ${producto.estado == "A" ? "checked" : ""}>
                    ...
                    "Opciones": `
                        <a onclick="readID('${producto.id}')" class="btn btn-warning" role="button" data-bs-toggle="modal" data-bs-target="#updateModal">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <a onclick="readID('${producto.id}')" class="btn btn-danger" role="button" data-bs-toggle="modal" data-bs-target="#deleteModal">
